...
public class ExampleStream extends AbstractAdapterIncludedStream {
  ...
  public SpDataStream declareModel() {
    return DataStreamBuilder.create("SBI.pe.source.example")
          ...
          .protocol(Protocols.kafka(Config.INSTANCE.getKafkaHost(), Config.INSTANCE.getKafkaPort(), "SBI.source.jvm"))
          .build();
  }
